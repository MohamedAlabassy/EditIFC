...
namespace EditIFC
{
    public partial class IfcVoidingFeatureForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            IPersist cuttingobj = Array.Find(mergedinstances, e1 => e1.GetType().GUID.Equals(instances[listBox1.SelectedIndex].GetType().GUID));
            IPersist tobecutobj = Array.Find(mergedinstances, e2 => e2.GetType().GUID.Equals(EditIfcMainForm.instances[listBox2.SelectedIndex].GetType().GUID));
            var mod = mergedmodel;
            ...
            using (var txn = mod.BeginTransaction("IfcVoidingFeature"))
            {
                ...
                var decomposition = create.RelAggregates(rel =>
               {
                ...
                voidingfeature.ObjectType = new IfcLabel("Element Spalling");
